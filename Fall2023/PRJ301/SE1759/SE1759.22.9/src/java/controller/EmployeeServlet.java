...
public class EmployeeServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        int count = Integer.parseInt(count_raw);
        List<Employee> list_employ = new ArrayList<>();
        for (int i = 0; i < count; i++) {
            ...
            if (i % 2 == 0) {
                gender = true;
                name = "Mr " + "Nguyen";
                salary = (double) i * 100000;
            } else {
                gender = false;
                name = "Miss " + "Nguyen";
                salary = (double) i * 200000;
            }
            Employee e = new Employee(i,name,gender,salary);
            list_employ.add(e);
        }
        request.setAttribute("data",list_employ);
