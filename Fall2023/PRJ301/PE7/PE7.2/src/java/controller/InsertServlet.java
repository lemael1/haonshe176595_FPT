...
public class InsertServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
      ...
      out.println("Accessdenied");
          ...
          DAO d= new DAO();
          List<Group> list_group=d.GetAllGroup();
    ...
    throws ServletException, IOException {
            ...
            String created_by=request.getParameter("by");
            DAO d= new DAO();
            int id=d.nextid();
            
            d.insertCandidate(name_raw,Integer.parseInt(gender_raw), dob_raw, gid, created_by);
