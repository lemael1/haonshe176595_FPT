...
public class EnrollServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        String DOE_raw=request.getParameter("date");
        out.println("Student Name: "+studentname_raw);
        out.println("Financial Source: "+source_raw);
        out.println("Level: "+level_raw);
        out.println("DOE: "+DOE_raw);
    }
