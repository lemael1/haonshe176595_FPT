...
public class DiemServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (toan_raw.equals("") || ly_raw.equals("") || hoa_raw.equals("") || van_raw.equals("") || anh_raw.equals("")) {
            ...
            try {
                ...
                String[] msg1 = khoi(toan, ly, hoa, van, anh, khoi, diemUT);
                request.setAttribute("data1", msg1);

                double DA = toan + ly + hoa + diemUT;
                double DA1 = toan + ly + anh + diemUT;
                double DD = toan + anh + van + diemUT;
                msg = CongBo(truong_raw, DA, DA1, DD, khoi);
                request.setAttribute("data2", msg);
    ...
    public String CongBo(String truong_raw, double DA, double DA1, double DD, String[] khoi) {
        String msg = "";
        String k = "";
        switch (truong_raw) {
            case "FPT":
