                        ...
                        <div class="row filter-row">       
                            <div class="col-sm-6 col-md-4">
                                <div class="form-group form-focus">
                                    ...
                                    <input type="text" class="form-control floating" name="searchValue" value = "${requestScope.searchValue}">
                                </div>
                            </div>
                            <div class="col-sm-6 col-md-4">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-striped custom-table">
                                    ...
                                    <tbody>
                                        ...
                                        <c:if test="${requestScope.employeeList != null && requestScope.searchList ==null }">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                        <div class="dropdown dropdown-action">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                <a class="dropdown-item" href="update-employee?id=${e.employeeId}"><i class="fa fa-pencil m-r-5"></i>Update</a>
                                                                <a class="dropdown-item" href="delete-employee?id=${e.employeeId}"  onclick="doDelete('${id}')"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
